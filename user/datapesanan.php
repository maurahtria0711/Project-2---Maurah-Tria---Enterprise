...
<aside style="height: auto; margin-bottom: 5px;">
	<center>
		...
		<div id="rekening" style="width: 60%; height: 200px;">
			<li>Rekening Karaoke Maurah Tria Rahmayami</li>
			<table style="width: 98%;">
				<tr style="text-align: center; border: 2px solid #B40301">
					...
					<td><img src="../gambar/bca.png" align="left"></td>
						...
						<tr>
							...
							if ($tglsekarang > $batasbayar) {
								...
								if ($status == "Pending...") {
									...
									if ($datay && is_array($datay)) { // Periksa apakah $datay adalah array
										...
										// Lakukan sesuatu jika tidak ada data yang ditemukan
