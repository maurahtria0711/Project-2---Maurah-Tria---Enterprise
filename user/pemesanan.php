...
?>
			...
			<tr>
				<td>Lama Booking</td>
				<td><input type="text" name="lama" onchange="hitung()" readonly="true" style="width: 100px;"> Jam</td>
			</tr>
			<tr>
				<td>Total Biaya</td>
...
?>
			...
			<tr>
				<td></td>
				<td><button type="submit" style="width:100px;background:#B40301; color:white;font-weight:bold;padding:5px;border:2px solid #B40301;">Booking Kamar</button></td>
			</tr>
		</table>
		</form>
<?php  
