...
?>
	...
	<div id="proff">
		...
		<div id="eg">
			<a href="editprofil" class="pass1" style="background-color: white;"> Edit/Upload Foto</a> | 
			<a href="#gantipassword" class="pass" style="background-color: white;"> Ganti Password</a>
		</div>
		</div>
	</div>
